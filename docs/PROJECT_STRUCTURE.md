...
`public/.nojekyll` is included in the static export so GitHub Pages serves the `_next/` directory generated by Next.js. The live site currently uses the `gh-pages` branch as its Pages source.
